...
def create_seed_inputs(tab):
    with FormGroup(visible=True, elem_id=f"{tab}_seed_group") as seed_group:
        with FormRow(elem_id=f"{tab}_seed_row", variant="compact"):
            ...
            seed_checkbox = gr.Checkbox(label='Extra', elem_id=f"{tab}_subseed_show", value=False, visible=True)

        seed_extras = []

        with FormRow(visible=False, elem_id=f"{tab}_subseed_row") as seed_extra_row_1:
            ...
            with gr.Column(variant='compact', elem_id="txt2img_settings"):
                ...
                with FormGroup(visible=show_second_pass.value, elem_id="txt2img_second_pass") as second_pass_group:
                    ...
                    with FormRow(elem_id="txt2img_hires_fix_row1", variant="compact"):
                        ...
                        refiner_start = gr.Slider(minimum=0.0, maximum=1.0, step=0.05, label='Refiner denoising start', value=0.8, elem_id="txt2img_refiner_start")
