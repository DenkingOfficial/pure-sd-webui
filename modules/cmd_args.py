...
parser = argparse.ArgumentParser(description="Stable Diffusion WebUI", conflict_handler='resolve', epilog='For other options see UI Settings page', prog='', add_help=True, formatter_class=lambda prog: argparse.HelpFormatter(prog, max_help_position=55, indent_increment=2, width=200))
...
group.add_argument('--api-only', action='store_true', help="Run in API only mode without starting UI", default=False)
