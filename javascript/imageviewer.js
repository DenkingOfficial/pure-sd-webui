...
function setupImageForLightbox(e) {
  ...
  const event = (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) ? 'mousedown' : 'click'; // TODO: fix right click; silly firefox workaround since it triggers events in wrong order
